        ...
        <Container>
          <Row className="justify-content-center align-items-center">
            <Col lg="11" xl="10" className="text-center">
              <Box>
                <Title variant="secSm">
                  I am taking new projects and an online store is under consstruction. If you'd like to chat please get in touch.
                </Title>
                ...
                >
                  <div className="d-flex flex-column flex-lg-row justify-content-center">
                    <LinkContact
                      href="mailto:sales@sageflowers.com"
                      target="_blank"
                    ...
                    <LinkContact
                      href="https://www.sageflowers.com"
                      target="_blank"
                    >
                      linkedin.com/folio
                    </LinkContact>
